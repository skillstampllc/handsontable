...
describe('preventOverflow option', function () {
  ...
  it('should set overflow to `hidden` for master table when `horizontal` value is not passed', function () {
    var wt = walkontable({
      data: getData,
  ...
  it('should set overflow to `hidden` for master table when `horizontal` value is passed', function () {
    var wt = walkontable({
      data: getData,
      totalRows: getTotalRows,
      totalColumns: getTotalColumns,
  ...
  it('should set overflow-x to `hidden` for top clone when `horizontal` value is passed', function () {
    var wt = walkontable({
      data: getData,
      totalRows: getTotalRows,
      totalColumns: getTotalColumns,
