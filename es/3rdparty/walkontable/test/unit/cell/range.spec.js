...
describe('CellRange', function () {
  describe('constructor()', function () {
    it('should clone each passed coordinates while assigning', function () {
      var highlight = new CellCoords(-1, -2);
      var from = new CellCoords(3, 4);
      var to = new CellCoords(5, 6);
      var range = new CellRange(highlight, from, to);
  ...
  describe('setHighlight()', function () {
    it('should clone the coordinates object while assigning', function () {
      var highlight = new CellCoords(-1, 6);
      var range = new CellRange(new CellCoords());
  ...
  describe('getHeight()', function () {
    it('should return range hight ignoring the negative values (headers) - from top-left to bottom-right', function () {
      var highlight = new CellCoords(-1, -2);
      var from = new CellCoords(-2, 1);
      var to = new CellCoords(5, 5);
      var range = new CellRange(highlight, from, to);
  ...
  describe('getWidth()', function () {
    ...
    it('should return range width ignoring the negative values (headers) - from top-right to bottom-left', function () {
      var highlight = new CellCoords(-1, -2);
      var from = new CellCoords(1, 5);
      var to = new CellCoords(5, -2);
      var range = new CellRange(highlight, from, to);
      expect(range.getWidth()).toBe(6);
    });
    it('should return range width ignoring the negative values (headers) - from bottom-left to top-right', function () {
      var highlight = new CellCoords(-1, -2);
      var from = new CellCoords(5, -2);
      var to = new CellCoords(1, 5);
      var range = new CellRange(highlight, from, to);
      expect(range.getWidth()).toBe(6);
    });
  ...
  describe('isSingle()', function () {
    it('should return `true` when `from` and `to` are equals and there is no header selected', function () {
      {
        var range = new CellRange(new CellCoords(0, 0), new CellCoords(4, 5), new CellCoords(4, 5));
        expect(range.isSingle()).toBe(true);
      }
      {
        var _range = new CellRange(new CellCoords(0, 0), new CellCoords(0, 0), new CellCoords(0, 0));
    ...
    it('should return `false` when `from` and `to` are equals and there is header selected', function () {
      {
        var range = new CellRange(new CellCoords(0, 0), new CellCoords(-1, 0), new CellCoords(-1, 0));
        expect(range.isSingle()).toBe(false);
      }
      {
        var _range2 = new CellRange(new CellCoords(0, 0), new CellCoords(0, -1), new CellCoords(0, -1));

        expect(_range2.isSingle()).toBe(false);
      }
      {
        var _range3 = new CellRange(new CellCoords(0, 0), new CellCoords(0, -1), new CellCoords(-1, 0));
    ...
    it('should return `false` when `from` and `to` are not equal', function () {
      {
        var range = new CellRange(new CellCoords(0, 0), new CellCoords(0, 0), new CellCoords(-1, 0));
        expect(range.isSingle()).toBe(false);
      }
      {
        var _range4 = new CellRange(new CellCoords(0, 0), new CellCoords(0, 0), new CellCoords(0, 1));

        expect(_range4.isSingle()).toBe(false);
      }
      {
        var _range5 = new CellRange(new CellCoords(0, 0), new CellCoords(0, 0), new CellCoords(1, 0));

        expect(_range5.isSingle()).toBe(false);
      }
      {
        var _range6 = new CellRange(new CellCoords(0, 0), new CellCoords(0, 0), new CellCoords(1, 1));

        expect(_range6.isSingle()).toBe(false);
      }
      {
        var _range7 = new CellRange(new CellCoords(0, 0), new CellCoords(-1, 0), new CellCoords(0, 0));

        expect(_range7.isSingle()).toBe(false);
      }
      {
        var _range8 = new CellRange(new CellCoords(0, 0), new CellCoords(0, 1), new CellCoords(0, 0));

        expect(_range8.isSingle()).toBe(false);
      }
      {
        var _range9 = new CellRange(new CellCoords(0, 0), new CellCoords(1, 0), new CellCoords(0, 0));

        expect(_range9.isSingle()).toBe(false);
      }
      {
        var _range10 = new CellRange(new CellCoords(0, 0), new CellCoords(1, 1), new CellCoords(0, 0));
